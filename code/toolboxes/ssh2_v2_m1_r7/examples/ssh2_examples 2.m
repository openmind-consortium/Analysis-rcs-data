...
command_output = ssh2_simple_command('pia.cin.ucsf.edu','pshirvalkar','11Zasdasd','ls -la *ninjas*',1);
...
ssh2_conn = ssh2_command(ssh2_conn, 'ls /data_store0/human/pcs_chronic_pain/CP4/CP4Lt/data/rawdata/');
