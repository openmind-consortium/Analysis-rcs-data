function [RCSdatabase_out] = RCSdatabase(rootdir,PATIENTIDside)
...
% OUTPUT: 
% 1. RCSdatabase.mat timetable with fields:
...
Log.app = unique_sorted_ALD;
Log.groupchange = unique_sorted_ELD;
Log.groupchange.time.TimeZone = 'America/Los_Angeles'; % assign same time zone as ProcessRCS
Log.adaptive = unique_sorted_AD;
Log.recharge = unique_sorted_RD; 
%% SAVE The Text Log structure
fn = [PATIENTIDside '_textlogs.mat'];
save(fullfile(rootdir,PATIENTID,fn),'Log')
